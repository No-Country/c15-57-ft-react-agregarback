  ...
  const infoData = [
    {
      ...
      information:
				'Proteger y conservar los hábitats naturales es esencial para la supervivencia de muchas especies. Esto puede implicar la creación y mantenimiento de áreas protegidas, parques nacionales y reservas naturales.'
    },
    {
      title: 'Control de la Caza y Pesca Ilegal',
      information:
				'Implementar medidas efectivas para prevenir la caza y pesca ilegal. Esto puede incluir el fortalecimiento de la legislación, el aumento de la aplicación de la ley y la concienciación pública sobre las consecuencias de estas prácticas.'
    },
    {
      title: 'Programas de Reproducción en Cautiverio',
      information:
				'Apoyar programas de reproducción en cautiverio para especies en peligro crítico. Estos programas pueden ayudar a aumentar las poblaciones y proporcionar individuos para futuras reintroducciones en la naturaleza.'
    },
    {
      title: 'Educación Ambiental',
      information:
				'Promover la educación ambiental para aumentar la conciencia sobre la importancia de la biodiversidad, los ecosistemas y el impacto humano en la vida silvestre. Esto puede fomentar un mayor respeto y cuidado por la naturaleza.'
    },
    {
      title: 'Sostenibilidad en el Uso de Recursos Naturales',
      information:
				'Fomentar prácticas sostenibles en el uso de recursos naturales, como la tala de bosques, la pesca y la agricultura. El uso responsable de los recursos es clave para mantener los ecosistemas saludables.'
    },
    {
      title: 'Reducción de la Contaminación',
      information:
				'Reducir la contaminación del aire, agua y suelo, ya que la contaminación puede tener efectos negativos en la salud de los animales y sus hábitats.'
    },
    {
      title: 'Lucha contra el Cambio Climático',
      information:
				'Contribuir a la lucha contra el cambio climático, ya que este fenómeno puede tener impactos significativos en los patrones climáticos, los hábitats y la distribución de especies.'
    },
    {
      title: 'Participación en Proyectos de Conservación',
      information:
				'Apoyar y participar en proyectos de conservación dirigidos por organizaciones ambientales y gubernamentales. Esto puede incluir donaciones, voluntariado o participación activa en iniciativas locales'
    },
    {
      title: 'Desarrollo Sostenible:',
      information:
				'Abogar por el desarrollo sostenible en comunidades locales y a nivel global. Esto implica equilibrar el desarrollo económico con la preservación de la biodiversidad y los ecosistemas.'
    },
    {
      title: 'Consumo Consciente',
      information:
				'Adoptar un estilo de vida de consumo consciente, eligiendo productos que sean respetuosos con el medio ambiente y no contribuyan a la degradación de hábitats naturales.'
    }
  ]
