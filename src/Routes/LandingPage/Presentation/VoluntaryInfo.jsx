  ...
  return(
    ...
    >
      ...
      <div className='w-[820px] flex flex-col items-center gap-6'>
        ...
        aventura. Nuestra gama de actividades está diseñada para satisfacer a viajeros de todas las edades y niveles de <br/>  experiencia. Descubre las emocionantes opciones que tenemos para ti:</p>
        <div className='relative z-10 border py-3 px-4 rounded-full bg-gray-500 bg-opacity-40'>
          <a className='text-white' href="#">Explorar</a>
        </div>
      </div>
