...
export default function TextArea ({ value }) {
  ...
  return (
    <div className='mb-3 h-[140px] font-roboto'>
      ...
      <Field as='textarea' name='textArea' className='font-roboto shadow appearance-none border rounded w-full py-3 px-3 leading-tight text-[0.8rem] lg:text-[1rem] bg-white h-[120px]' id='textArea' placeholder='Ingrese una descripción de la ubicación donde se encuentra' value={value} maxLength={maxCharacters} />
