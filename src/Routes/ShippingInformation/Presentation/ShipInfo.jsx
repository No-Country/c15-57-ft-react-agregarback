...
export default function ShipInfo () {
  return (
    <div className='w-full flex flex-col justify-center items-center rounded fixed left-0 sm:left-[25%] md:static max-w-[339px] bg-white md:self-start md:mt-[48px]'>
      ...
      <h2 className='mx-4 text-base font-robotoM self-start mb-[19px] hidden md:inline'>
        DHL Express Worldwide
      </h2>
      <p className='text-[0.8rem] font-light mx-4 mb-[19px]'>
      ...
      <div className='flex mx-4 w-[90%] justify-evenly'>
        <div>
      ...
      <div className='flex mx-4 w-[90%] justify-evenly md:mt-3'>
        <div>
          <RiArrowRightDoubleFill className='text-red-600 text-[18px]' />
        </div>
