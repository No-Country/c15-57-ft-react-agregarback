...
const CartCounterLayout = ({ children }) => {
  ...
  return (
    <div className={`
    ${animalRouterChecker
        ? 'bg-lime-200 w-[4vw] h-[2vh] right-[12vw] rounded-[12px] absolute bottom-[4vh] sm:w-[3vw] sm:right-[-4.8vw] sm:bottom-[3vh] md:w-[1vw] md:right-[-2vw] md:bottom-[0.9vh]  lg:right-[-1vw] 2xl:right-[-1vw]'
