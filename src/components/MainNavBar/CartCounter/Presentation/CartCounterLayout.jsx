...
const CartCounterLayout = ({ children }) => {
  ...
  return (
    ...
    ${animalRouterChecker
        ...
        : 'bg-black absolute rounded-full w-[5vw] h-[3vh] right-[13.2vw] top-[2vh] sm:w-[3vw]  sm:right-[-5.8vw] sm:top-[-1.5vh] md:w-[1vw] md:right-[-1vw] md:top-[-2vh]  lg:right-[-2vw] lg:top-[-1.5vh]  2xl:top-[-.9vh] 2xl:right-[-1vw]'
      }`}
    >
      {children}
