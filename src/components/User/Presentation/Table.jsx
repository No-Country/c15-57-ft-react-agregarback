...
const Table = ({ data }) => {
  return (
    <div className='grid grid-cols-5 text-center mb-6 '>
      ...
      <div className='col-span-1 bg-gray-200 text-transparent '>Detalles </div>
      ...
      {data.map((data, index) => {
        return (
          <Fragment key={index}>
            ...
            <div className='col-span-1 font-robotoM text-[0.7rem] sm:text-[1rem] text-green-600 mt-6'>Ver detalles</div>
          </Fragment>
        )
      }
      )}
